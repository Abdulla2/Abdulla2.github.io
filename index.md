...
I haven't added anything yet to the project so I'll rant a little about an open source project I recommend and like and hope to learn haskell for the niche that this language is and for this project after that I will stop writing and try to implement my static site generator and maybe return to you with results or nothing at all.

### Rant about Pandoc

I mentioned pandoc before as the tool I use currently to generate this site, but actually pandoc is the swiss army knife for document converting, they support formats you wouldn't even hear about except for on their documentation let's like a cheap TV comercial list the features I encountered or used in Pandoc:

* Obviously Markdown is the main format it supports, but it doesn't support markdown it supports every variant and every extension for it and even their own extensions: want tables? like 10 extensions for that alone, want biblography they support that, latex math inside the markdown of course and every thing you dream of in a text document.

* This Markdown you can convert it to any document or (sometimes non-document formats) in the world:
    
* To presentation: for non formal casual ones you can convert to javascript formats maybe revealjs(I used this the most), you can make the presentation self contained you can choose which header level counts for new slide and more other things; You can also if it's something formal convert to regular presentation formats the most famous powerpoint, and also ODF formats are also supported.

* In all those formats of course it supports templates, you can write all you want and generate every time with a consistent style.

* What was Surprising to me that it is very big program for a cli program: it's more than 100 Mbytes, I only imagine how much code in this.

* It uses Haskell which is the only non-extent or used pure functional programming language, if you don't know what does that mean; neither do I but I an looking forward one day I will learn it.
